              ...
              <div className="px-6 py-5">
                <div className="space-y-4">
                  ...
                  <div className="pt-8 grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    {/* Simple Matches Button */}
                    <button
                      onClick={() => router.push(`/matches?league=${leagueId}`)}
                      className="flex flex-col items-center justify-center p-6 bg-teal-50 hover:bg-teal-100 dark:bg-teal-900/20 dark:hover:bg-teal-900/30 rounded-xl transition-colors shadow-sm hover:shadow"
                      title="Spieltage anzeigen"
                      disabled={!leagueId} // Disable if leagueId isn't available
                    >
                      {/* Simple SVG placeholder or just text */}
                       <svg className="h-12 w-12 text-teal-600 dark:text-teal-400 mb-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                         <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0h18M7.5 11.25h.008v.008H7.5v-.008Zm3.75 0h.008v.008h-.008v-.008Zm3.75 0h.008v.008h-.008v-.008Z" />
                       </svg>
                      <span className="text-lg font-medium text-teal-800 dark:text-teal-300">Matches</span>
                    </button>
                  </div>
                </div>
              </div>
